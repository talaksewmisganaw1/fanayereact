...
export default function Opening({isAnimating, setIsAnimating, loader}) {
  ...
  return (
    <div className="splash-container z-40">
      ...
      <div className={`${!loader? ' animate-fade-in ': '' } ${isAnimating ? ' go-top ' : ''} ${ispadding? ' md:ml-4 lg:pl-[8.4vw] h-20 flex items-center ': ''} name font-[Delius] fixed mt-0 text-accent w-full`}>Fanaye Girma</div>
